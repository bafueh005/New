            ...
            {submitted ? (
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <Field label="Full name"><input required className="input" placeholder="Adaeze Nwosu" /></Field>
                  <Field label="Work email"><input required type="email" className="input" placeholder="you@company.com" /></Field>
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                  <Field label="Current role">
                    <input className="input" placeholder="e.g. Systems Engineer" />
                  </Field>
                  <Field label="Target role">
                    <input className="input" placeholder="e.g. Sr. Cloud Engineer" />
                  </Field>
                </div>

                <Field label="Program of interest">
                  <select className="input" defaultValue={PROGRAMS[6]}>
                ...
                <Field label="What would you like to focus on?">
                  <textarea rows={4} className="input resize-none" placeholder="Quick context: where you are, where you want to go, what's been blocking interviews so far." />
                </Field>

                <div className="flex items-center gap-3">
                  <input type="checkbox" id="resume" className="h-4 w-4 rounded border-slate-300" />
                ...
                <button type="submit" className="btn-primary mt-2 w-full sm:w-auto">
                  Submit and schedule <ArrowRight className="h-4 w-4" />
                </button>
